...
SELECT count(id) as Ocorrencias, 
    CASE
    WHEN data_O >= '2020.01.01 00:00' and data_O <= '2020.01.31 23:59' THEN count(id)/31
    WHEN data_O >= '2020.02.01 00:00' and data_O <= '2020.02.29 23:59' THEN count(id)/29
    WHEN data_O >= '2020.03.01 00:00' and data_O <= '2020.03.31 23:59' THEN count(id)/31
    WHEN data_O >= '2020.04.01 00:00' and data_O <= '2020.04.30 23:59' THEN count(id)/30
    WHEN data_O >= '2020.05.01 00:00' and data_O <= '2020.05.31 23:59' THEN count(id)/31
    WHEN data_O >= '2020.06.01 00:00' and data_O <= '2020.06.30 23:59' THEN count(id)/30
    WHEN data_O >= '2020.07.01 00:00' and data_O <= '2020.07.31 23:59' THEN count(id)/31
    WHEN data_O >= '2020.08.01 00:00' and data_O <= '2020.08.31 23:59' THEN count(id)/31
    WHEN data_O >= '2020.09.01 00:00' and data_O <= '2020.09.30 23:59' THEN count(id)/30
    WHEN data_O >= '2020.10.01 00:00' and data_O <= '2020.10.31 23:59' THEN count(id)/31
    WHEN data_O >= '2020.11.01 00:00' and data_O <= '2020.11.30 23:59' THEN count(id)/30
    WHEN data_O >= '2020.12.01 00:00' and data_O <= '2020.12.31 23:59' THEN count(id)/31
    END AS Media_Diaria,
      
    CASE
    WHEN data_O >= '2020.01.01 00:00' and data_O <= '2020.01.31 23:59' THEN 'A'
    WHEN data_O >= '2020.02.01 00:00' and data_O <= '2020.02.29 23:59' THEN 'B'
    WHEN data_O >= '2020.03.01 00:00' and data_O <= '2020.03.31 23:59' THEN 'C'
    WHEN data_O >= '2020.04.01 00:00' and data_O <= '2020.04.30 23:59' THEN 'D'
    WHEN data_O >= '2020.05.01 00:00' and data_O <= '2020.05.31 23:59' THEN 'E'
    WHEN data_O >= '2020.06.01 00:00' and data_O <= '2020.06.30 23:59' THEN 'F'
    WHEN data_O >= '2020.07.01 00:00' and data_O <= '2020.07.31 23:59' THEN 'G'
    WHEN data_O >= '2020.08.01 00:00' and data_O <= '2020.08.31 23:59' THEN 'H'
    WHEN data_O >= '2020.09.01 00:00' and data_O <= '2020.09.30 23:59' THEN 'I'
    WHEN data_O >= '2020.10.01 00:00' and data_O <= '2020.10.31 23:59' THEN 'J'
    WHEN data_O >= '2020.11.01 00:00' and data_O <= '2020.11.30 23:59' THEN 'K'
    WHEN data_O >= '2020.12.01 00:00' and data_O <= '2020.12.31 23:59' THEN 'L'
    END AS Mes      
FROM dados
...
var chart = new CanvasJS.Chart("chartContainer", {
	title: {
		text: "Media de Casos Mensais em 2020"
	},
	theme: "light1",
